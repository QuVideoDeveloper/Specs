...
#智能调色
s.subspec 'SmartColor' do |sColor|
  sColor.dependency 'QVAIVideoEngineAI/Core'
  sColor.dependency 'QVAIVideoEngineAI/CommonLibs'
  sColor.source_files = 'QVAIVideoEngineAI/Libs/SmartColor/Classs/**/*'
  sColor.public_header_files = 'QVAIVideoEngineAI/Libs/SmartColor/Classs/public/*.h'
  sColor.private_header_files = 'QVAIVideoEngineAI/Libs/SmartColor/Classs/Include/*.h'
  sColor.vendored_libraries = 'QVAIVideoEngineAI/Libs/SmartColor/Libs/**/*.a'
end

#副歌提取
s.subspec 'Chorus' do |sChorus|
  sChorus.dependency 'QVAIVideoEngineAI/Core'
  sChorus.dependency 'QVAIVideoEngineAI/CommonLibs'
  sChorus.source_files = 'QVAIVideoEngineAI/Libs/Chorus/Classs/**/*'
  sChorus.public_header_files = 'QVAIVideoEngineAI/Libs/Chorus/Classs/public/*.h'
  sChorus.private_header_files = 'QVAIVideoEngineAI/Libs/Chorus/Classs/Include/*.h'
  sChorus.vendored_libraries = 'QVAIVideoEngineAI/Libs/Chorus/Libs/**/*.a'
end
